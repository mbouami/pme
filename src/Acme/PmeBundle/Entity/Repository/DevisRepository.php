...
class DevisRepository extends EntityRepository
{
    ...
    {     
        ...
        $query = $this->getEntityManager()
                        ->createQuery("SELECT p FROM AcmePmeBundle:Lignesdevis p WHERE p.devis=:iddevis Order By p.ordre")
    ...
    public function ListeDerniersDevis($id) {
        ...
        $query = $this
            ...
            ->where('Not Exists (select v.id from AcmePmeBundle:Devis v where v.parent=u.id)')
